...
namespace lve {
  ...
  void LvePipeline::createGraphicsPipeline(const std::string& vertFilePath, const std::string& fragFilePath, const PipelineConfigInfo& configInfo) {
    ...
    createShaderModlue(vertCode, &vertShaderModule);
    createShaderModlue(fragCode, &fragShaderModule);
  ...
  void LvePipeline::createShaderModlue(const std::vector<char>& code, VkShaderModule* shaderModule)
  {
